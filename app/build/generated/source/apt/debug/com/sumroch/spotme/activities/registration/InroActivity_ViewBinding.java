...
public class InroActivity_ViewBinding implements Unbinder {
  private InroActivity target;
  ...
  @UiThread
  public InroActivity_ViewBinding(InroActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public InroActivity_ViewBinding(final InroActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    InroActivity target = this.target;
