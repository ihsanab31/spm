 ...
 * This class for
 */
public class InroActivity extends NormalActivity implements FacebookResponse, GoogleAuthResponse, Validator.ValidationListener {
    ...
    void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_sign_up:
                startActivity(new Intent(InroActivity.this, RegistrationActivity.class));
                break;
            case R.id.btn_forgot_password:
                startActivity(new Intent(InroActivity.this, ForgotPasswordActivity.class));
                break;
