...
public class DataParkirCommand extends ApiService<Object, List<DataParkir>> {

    public DataParkirCommand(Object o) {
        super(o);
    }

    @Override
    public Call<ApiResponse<List<DataParkir>>> getApi() {
        return HttpClient.getInstance().getApi().getDataParkir();
    }
}
